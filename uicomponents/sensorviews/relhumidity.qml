        ...
        ChartView {
            ...
            LineSeries {
                ...
                property var refresh: function() {
                    var data = log;
                    removePoints(0, lineSeriesHumidity.count)
                    for(var i = 0; i < data.length; i++) {
                        if(data[i] >= axisY.max) {
                            axisY.max = data[i] +5
                        }
                        lineSeriesHumidity.append(data.length - i, data[i]);
        ...
        ChartView {
            ...
            property var refresh: function(json) {
                ...
                for(var i = 0; i <= 24 || json[i] !== undefined; i++) {
                    ...
                    lineSeriesHumidityPreviewMin.append(i, json[i]["min"])
                    lineSeriesHumidityPreviewMax.append(i, json[i]["max"])
                    lineSeriesHumidityPreviewMedian.append(i, (json[i]["max"] + json[i]["min"]) /2 )
            ...
            LineSeries {
                id : lineSeriesHumidityPreviewMin
                name: "Min."
                axisX: axisXPreview
                axisY: axisYPreview
                color: "#2196F3"
            ...
            LineSeries {
                id : lineSeriesHumidityPreviewMax
                name: "Max."
                axisX: axisXPreview
                axisY: axisYPreview
                color: "#F44336"
            ...
            LineSeries {
                id : lineSeriesHumidityPreviewMedian
                name: "Mid."
                axisX: axisXPreview
                axisY: axisYPreview
                color: "#607D8B"
